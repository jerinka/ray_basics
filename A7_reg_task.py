...
@ray.remote
def register(img1_color,img2_color):
    '''Registe two images'''
    start6 = time.time()
...
if __name__=='__main__':
    ...
    for j in range(10):
        ...
        for i in range(n):
            ...
            # remote register id
            #start3 = time.time()
            transformed_img_ref = register.remote(img1_color,img2_color)
            resustl_refs.append(transformed_img_ref)
            print('Time ref id:',time.time()-start2)
        ...
        print('\n## Time per reg:',(time.time()-start0)/n) 
